...
exports.default = {
    ...
    invalidWriter: function invalidWriter(writer) {
        return 'The opts.writer property "' + writer + '" does not appear to be valid (must be a function).';
    },
    ...
    noWriter: function noWriter() {
        return 'The opts.writer property is missing.';
    },
